...
int main(int argc, char** argv) {
    ...
    try {
        ...
        // Wait for all Lua staged tests to complete (~18 seconds of tests)
        std::cout << "[Test] Running Lua-driven tests (this will take ~18 seconds)..." << std::endl;
